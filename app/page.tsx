...
export const metadata: Metadata = {
  ...
  description: 'تصفّح وابحث في النصوص التشريعية والتنظيمية المغربية — المادة الجنائية، المدنية، الأسرية، التجارية والعقارية. المسطرة الجنائية، القانون الجنائي، مدونة الأسرة ومدونة الشغل. جميع النصوص من الجريدة الرسمية مجاناً.',
  openGraph: {
    title: 'المدوّنة — الموسوعة القانونية المغربية',
