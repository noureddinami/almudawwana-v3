...
export const metadata: Metadata = {
  ...
  description: 'ابحث في أكثر من 3,390 مادة قانونية — بحث سريع في المسطرة الجنائية، القانون الجنائي، مدونة الأسرة ومدونة الشغل. بحث بالنص الحر، برقم المادة أو بكلمات مفتاحية.',
  openGraph: {
    title: 'البحث في القوانين المغربية | المدوّنة',
    description: 'بحث سريع في 3,390 مادة قانونية — المسطرة الجنائية، القانون الجنائي، مدونة الأسرة، مدونة الشغل.',
